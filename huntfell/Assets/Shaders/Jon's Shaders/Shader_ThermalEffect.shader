...
Shader "Shader Forge/Barricade" {
    Properties {
        ...
        _OpacitySlider ("OpacitySlider", Range(0, 1)) = 1
        _DontTouch ("Don't Touch", Color) = (0.5,0.5,0.5,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _OpacitySlider;
            uniform float4 _DontTouch;
            struct VertexInput {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip((node_3952*_OpacitySlider*_DontTouch.a) - 0.5);
