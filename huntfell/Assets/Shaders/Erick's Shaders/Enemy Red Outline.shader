...
Shader "Shader Forge/Erick's Shaders/Enemy Red Outline" {
    Properties {
        ...
        _Dark ("Dark", Color) = (0.7352941,0,0,1)
        _Light ("Light", Color) = (0.625,0.4457721,0.4457721,1)
