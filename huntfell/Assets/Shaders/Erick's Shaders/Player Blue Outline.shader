...
Shader "Shader Forge/Erick's Shaders/Player Blue Outline" {
    Properties {
        ...
        _Dark ("Dark", Color) = (0,0.05347588,0.5882353,1)
        _Light ("Light", Color) = (0.4929715,0.5109901,0.6911765,1)
        _OutlineWidth ("Outline Width", Float ) = 0
        _OutlineColor ("Outline Color", Color) = (0,0.09090901,1,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
